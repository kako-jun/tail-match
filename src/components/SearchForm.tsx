...
import { Box, FormControl, Select, MenuItem, Button, Grid, Typography } from '@mui/material';
        ...
        <FormControl fullWidth>
          <Select
            ...
            onChange={(e) =>
              handleChange(
                'region_id',
                e.target.value ? parseInt(String(e.target.value)) : undefined
              )
            }
            sx={selectSx}
          >
            ...
            <MenuItem value="11" sx={{ fontSize: '0.875rem' }}>
              神奈川県
            </MenuItem>
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          ...
          <FormControl fullWidth>
            ...
            >
              ...
              <MenuItem value="7" sx={{ fontSize: '0.875rem' }}>
                1週間以内
              </MenuItem>
              <MenuItem value="14" sx={{ fontSize: '0.875rem' }}>
                2週間以内
              </MenuItem>
            </Select>
          </FormControl>
