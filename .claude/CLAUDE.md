...
#### 1.2 データベース環境構築
- [ ] PostgreSQL Docker Compose 設定
- [ ] 環境変数設定 (.env.local)
- [ ] データベース接続確認
- [ ] 基本テーブル作成 (regions, municipalities, tails)

#### 1.3 Next.js API基盤
- [ ] PostgreSQL接続ライブラリ設定
- [ ] 基本的なAPI Routes作成 (/api/tails)
- [ ] CRUD操作の実装
- [ ] API動作確認
...
### Phase 2: スクレイピングシステム (2-3週間)
**目標**: 1つの自治体サイトから情報を取得

#### 2.1 Python環境構築
- [ ] requirements.txt作成
- [ ] BeautifulSoup + requests基本実装
- [ ] データベース接続 (Python)
- [ ] 基本的なスクレイピング動作確認
