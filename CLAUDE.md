...
- **Node.js スクレイピング** - axios + cheerio（osaka-kenpo + kanazawa-dirt パターン）
...
- **🚨 犬用ページの完全無視問題** (2025-11-12発見):
  - **7施設で犬用ページが存在するのに完全にスクレイピング対象外**
  - **千葉市**: transferdogs.html (200 OK)
  - **千葉県**: shuu-inu-tou.html (200 OK)
  - **福井県**: /animal_kind/dog/ (200 OK)
  - **神奈川県**: receive/dog.html (200 OK)
  - **京都府**: /recruit-animal/dog/ (200 OK)
  - **沖縄県**: /transfer/dogs (200 OK)
  - **富山県**: dog.html (200 OK)
  - 影響: 多数の保護犬が見逃されている可能性（致命的）
- **🚨 フォールバック抽出問題**:
