...
/**
 * 前橋市保健所 HTML収集スクリプト（犬）
 *
 * URL: https://www.city.maebashi.gunma.jp/soshiki/kenko/eiseikensa/gyomu/1/1/3/17337.html
 */
...
const CONFIG = {
  ...
  url: 'https://www.city.maebashi.gunma.jp/soshiki/kenko/eiseikensa/gyomu/1/1/3/17337.html',
  expected_selectors: 'table, div.main',
  timeout: 30000,
  waitTime: 5000,
};
...
/**
 * HTML内の動物数をカウント
 * 前橋市はテーブル形式（管理番号 D2025-XXX）
 */
function countAnimalsInHTML(html) {
  // 管理番号パターンで検出（D2025-XXX）
  const idPattern = /D2025-\d+/gi;
