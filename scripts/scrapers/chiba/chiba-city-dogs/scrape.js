...
/**
 * 千葉市動物保護指導センター（犬） HTML収集スクリプト
 *
 * URL: https://www.city.chiba.jp/hokenfukushi/iryoeisei/seikatsueisei/dobutsuhogo/transferdogs.html
 */
...
async function main() {
  ...
  console.log('🐕 千葉市動物保護指導センター（犬） - HTML収集');
  console.log('='.repeat(60));
