...
/**
 * 北九州市動物愛護センター HTML収集スクリプト（猫）
 *
 * URL: https://www.city.kitakyushu.lg.jp/contents/924_11835.html
 */
...
async function main() {
  ...
  console.log('🐱 北九州市動物愛護センター - HTML収集（猫）');
  console.log('='.repeat(60));
...
/**
 * HTML内の動物数をカウント
 * 北九州市は成猫・子猫のテーブル内の<tr>タグ（ヘッダー除く）をカウント
 */
