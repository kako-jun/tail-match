...
const CONFIG = {
  municipality: 'fukuoka/fukuoka-pref-cats',
  municipalityId: null, // TODO: DB登録後に設定
  base_url: 'https://www.zaidan-fukuoka-douai.or.jp',
  source_url: 'https://www.zaidan-fukuoka-douai.or.jp/animals/centers/cat',
};
...
async function main() {
  ...
  console.log('🐱 福岡県動物愛護センター（猫） - YAML抽出');
  console.log('='.repeat(60) + '\n');
    ...
    const yamlContent = yaml.dump(
      {
        meta: {
          ...
          note: '福岡県動物愛護センター譲渡猫情報（公益財団法人運営）',
        },
        animals: allCats,
      },
