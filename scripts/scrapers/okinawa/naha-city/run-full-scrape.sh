...
# ================================================================
# 那覇市動物愛護管理センター 完全自動スクレイピングスクリプト
# ================================================================
#
# 使用方法:
#   ./scripts/scrapers/okinawa/naha-city/run-full-scrape.sh
#
# 実行内容:
#   1. HTMLをスクレイピング
#   2. HTMLからYAMLに情報を抽出
...
echo "============================================================"
echo "🐱 那覇市動物愛護管理センター - 完全自動スクレイピング"
echo "============================================================"
echo ""
...
echo ""
echo "次のステップ:"
echo "  1. data/yaml/okinawa/naha-city/ のYAMLファイルを確認"
echo "  2. データベースに投入:"
