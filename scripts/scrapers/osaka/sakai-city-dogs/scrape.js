...
/**
 * 堺市動物指導センター HTML収集スクリプト
 *
 * URL: https://www.city.sakai.lg.jp/kurashi/gomi/dobutsu/dogdog/jyoto/index.html
 */
...
const CONFIG = {
  ...
  url: 'https://www.city.sakai.lg.jp/kurashi/dobutsu/dogcat/inunekojoto/centerdogs.html',
...
async function main() {
  ...
  try {
    ...
    const metadata = {
      ...
      url: CONFIG.url,
      has_animals: html.includes('犬') || html.includes('ネコ') || html.includes('ねこ'),
