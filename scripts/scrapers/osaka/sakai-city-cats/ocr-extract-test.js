...
const CONFIG = {
  municipality: 'kanagawa/sakai-city-cats',
  testLimit: 1,
};
...
async function main() {
  ...
  console.log('🧪 テスト: 堺市動物愛護センター - 画像OCR抽出（1枚）');
  console.log('='.repeat(60) + '\n');
  ...
  const imagesDir = path.join(process.cwd(), 'data', 'images', 'osaka', 'sakai-city');
