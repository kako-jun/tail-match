...
const CONFIG = {
  ...
  image_urls: [
    ...
    '/kurashi/dobutsu/dogcat/inunekojoto/cats1.images/R7_4.png',
    '/kurashi/dobutsu/dogcat/inunekojoto/cats2.images/R7_5.png',
    '/kurashi/dobutsu/dogcat/inunekojoto/cats2.images/R7_6.png',
    '/kurashi/dobutsu/dogcat/inunekojoto/cats2.images/R7_7.png',
    '/kurashi/dobutsu/dogcat/inunekojoto/cats2.images/R7_8.png',
...
function createManualDataTemplate(imageFilename, imageUrl) {
  ...
  return {
    ...
    name: null, // 要手動入力
    animal_type: imageUrl.includes('dogs') ? 'dog' : 'cat',
    breed: null, // 要手動入力
    ...
    source_url:
      ...
      (imageUrl.includes('dogs')
        ? '/kurashi/dobutsu/dogcat/inunekojoto/centerdogs.html'
        : `/kurashi/dobutsu/dogcat/inunekojoto/cats${imageUrl.match(/cats(\d)/)?.[1] || '1'}.html`),
  ...
  const yamlContent = yaml.dump(
    {
      meta: {
        ...
        source_url: CONFIG.base_url + '/kurashi/dobutsu/dogcat/inunekojoto/index.html',
