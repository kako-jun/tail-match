 ...
 *
 * URL: https://www.city.sendai.jp/dobutsu/kurashi/shizen/petto/hogodobutsu/joho/inu.html
 */
 ...
 * 管理番号パターン: D24018（D + 5桁の数字）
 */
function countAnimalsInHTML(html) {
  // パターン: 管理番号D24018形式を抽出（<td>または<p>タグ内）
  const managementNumberPattern = /(?:<td[^>]*>|<p[^>]*>)(D\d{5})(?:<\/td>|<\/p>)/gi;
  const matches = [];
  let match;
