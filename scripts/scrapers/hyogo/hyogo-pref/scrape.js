...
/**
 * 兵庫県動物愛護センター HTML収集スクリプト
 *
 * URL: https://web.pref.hyogo.lg.jp/kf14/koinukoneko.html
 */
...
const CONFIG = {
  municipality: 'hyogo/hyogo-pref',
  url: 'http://www.hyogo-douai.sakura.ne.jp/jyouto4.html',
...
async function main() {
  ...
  console.log('🐱 兵庫県動物愛護センター - HTML収集');
  console.log('='.repeat(60));
