...
# ================================================================
# 神戸市動物管理センター 完全自動スクレイピングスクリプト
# ================================================================
#
# 使用方法:
#   ./scripts/scrapers/hyogo/kobe-city/run-full-scrape.sh
#
# 実行内容:
#   1. HTMLをスクレイピング
#   2. HTMLからYAMLに情報を抽出
...
echo ""
echo "次のステップ:"
echo "  1. data/yaml/hyogo/kobe-city/ のYAMLファイルを確認"
echo "  2. データベースに投入:"
