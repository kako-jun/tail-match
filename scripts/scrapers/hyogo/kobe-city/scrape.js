...
/**
 * 神戸市動物管理センター HTML収集スクリプト
 *
 * URL: https://www.city.kobe.lg.jp/a84140/kenko/health/hygiene/animal/zmenu/index.html
 */
...
async function main() {
  ...
  console.log('🐱 神戸市動物管理センター - HTML収集');
  console.log('='.repeat(60));
  ...
  try {
    ...
    const metadata = {
      ...
      url: CONFIG.url,
      has_animals: html.includes('猫') && !html.includes('収容した猫はいません'),
