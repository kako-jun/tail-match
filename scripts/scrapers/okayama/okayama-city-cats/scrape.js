...
/**
 * 岡山市保健所 猫用 HTMLスクレイピングスクリプト
 * URL: https://www.city.okayama.jp/kurashi/0000016404.html
 */
...
async function scrapeWithPlaywright() {
  ...
  console.log('🐾 岡山市保健所（猫） - HTMLスクレイピング');
  console.log('='.repeat(60) + '\n');
  ...
  try {
    ...
    const filename = `okayama-city-cats-${timestamp}.html`;
